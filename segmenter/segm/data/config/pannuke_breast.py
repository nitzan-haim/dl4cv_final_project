...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        img_dir="Breast/Fold_1/images",
        ann_dir="Breast/Fold_1/masks",
        pipeline=train_pipeline,
    ),
    trainval=dict(
        type=dataset_type,
        data_root=data_root,
        img_dir=["Breast/Fold_1/images", "Breast/Fold_2/images"],
        ann_dir=["Breast/Fold_1/masks", "Breast/Fold_2/masks"],
        pipeline=train_pipeline,
    ),
    val=dict(
        type=dataset_type,
        data_root=data_root,
        img_dir="Breast/Fold_2/images",
        ann_dir="Breast/Fold_2/masks",
        pipeline=val_pipeline,
    ),
    test=dict(
        type=dataset_type,
        data_root=data_root,
        img_dir="Breast/Fold_3/images",
        ann_dir="Breast/Fold_3/masks",
